...
function demoTestDatabase() {
  ...
  console.log(`Total Users:          ${(stats.totalUsers as any).count}`);
  console.log(`Active Users:         ${(stats.activeUsers as any).count}`);
  console.log(`Total Products:       ${(stats.totalProducts as any).count}`);
  console.log(`Total Orders:         ${(stats.totalOrders as any).count}`);
  console.log(`Total Revenue:        $${(stats.totalRevenue as any).total}`);
  console.log(`Avg Order Value:      $${(stats.avgOrderValue as any).avg}`);
  console.log(`Total Reviews:        ${(stats.totalReviews as any).count}`);
  console.log(`Average Rating:       ${(stats.avgRating as any).avg}/5.0`);
